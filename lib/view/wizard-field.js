...
class WizardField {
  ...
  _defaultRenderer(){
    return <atom-text-editor ref="field" id={this.props.field.id}
      attributes={{mini: true, tabindex: this.props.tabindex ? this.props.tabindex : -1}}>
    </atom-text-editor>
  }
  ...
  _selectRenderer(){
    var self = this;
    return <select class="input-select" ref="field" id={this.props.field.id} attributes={{tabindex: this.props.tabindex ? this.props.tabindex : -1}}>
