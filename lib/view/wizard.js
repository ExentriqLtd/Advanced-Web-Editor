...
class Wizard {
  ...
  getLanguage(){
    return this.refs['__language'].getValue();
  }
  ...
  finish(){
    ...
    this.contentFolder = path.join(this.cloneDir(), this.getLanguage(), this.editorFields[this.currentContentIndex].path);
  ...
  renderContentFields(){
    ...
    return <div class='awe-wizard'>
      ...
      <div class="block">
        ...
        <LanguageSelect ref="__language" tabindex={1}></LanguageSelect>
      </div>
  ...
  renderField(field, i){
    return <div class="block">
      ...
      <WizardField ref={field.id} field={field} items={this.items[field.id]} tabindex={i + 2}></WizardField>
    </div>
  }
